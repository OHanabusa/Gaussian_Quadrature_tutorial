...
| 3     | \(0.7745966692, 0\)                   | 0.5555555556 (両端), 0.8888888889 (中央)                    |
| 4     | \(0.8611363116, 0.3399810436\)     | 0.3478548451 (外側), 0.6521451549 (内側)                    |
| 5     | \(0.9061798459, 0.5384693101, 0\) | 0.2369268851 (最外), 0.4786286705 (中間), 0.5688888889 (中央) |
...
**式 (2) の意味**：パラメータ ξ を用いて線形写像を定義し、標準区間 [-1,1] の任意点 ξ を区間 [x_1,x_2] の点 x へマッピングします。
...
![image](https://github.com/user-attachments/assets/5b8cd0e3-7dfd-447b-8c13-5f7518f0ca70)
...
![image](https://github.com/user-attachments/assets/16aaa1fa-292b-4ad9-a9ac-d8f2237f575f)

  ただし ξ_i はガウス点，w_i は対応する重み。

- 二重積分の場合，ξ と η のそれぞれに同じ n 点ガウス求積を適用すると，
![image](https://github.com/user-attachments/assets/71ec5f09-9149-403c-95f8-773a99a1de86)
...
参照空間上の積分式に上記を適用すると，
![image](https://github.com/user-attachments/assets/8ead7123-dc78-4d3a-a747-2caf4c496693)
